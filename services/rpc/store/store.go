...
import (
	...
	"github.com/k8scommerce/k8scommerce/services/rpc/store/internal/config"
	"github.com/k8scommerce/k8scommerce/services/rpc/store/internal/server"
...
func main() {
	...
	srv := server.NewStoreClientServer(ctx)
