...
// UnimplementedPaymentClientServer can be embedded to have forward compatible implementations.
...
func RegisterPaymentClientServer(s *grpc.Server, srv PaymentClientServer) {
	s.RegisterService(&_PaymentClient_serviceDesc, srv)
}
...
var _PaymentClient_serviceDesc = grpc.ServiceDesc{
