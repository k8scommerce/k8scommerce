module github.com/k8s-commerce/k8s-commerce/services/rpc/othersbought
...
require (
	...
	github.com/k8s-commerce/k8s-commerce/services/rpc/product v0.0.0-20211230223157-c870ddb2c12a
