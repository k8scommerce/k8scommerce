...
// products
func (m *othersBoughtRepo) GetProductBySku(sku string) (res *productResponse, err error) {
...
func (m *othersBoughtRepo) GetProductBySlug(slug string) (res *productResponse, err error) {
	nstmt, err := m.db.PrepareNamed(`
		WITH p AS (
			SELECT 
				product.* 
...
func (m *othersBoughtRepo) GetProductById(productID int64) (res *productResponse, err error) {
	nstmt, err := m.db.PrepareNamed(`
		WITH p AS (
			SELECT 
				product.* 
...
func (m *othersBoughtRepo) GetProductsByCategoryId(categoryID, currentPage, pageSize int64, sortOn string) (res *getByCategoryIDResponse, err error) {
...
func (m *othersBoughtRepo) GetAllProducts(currentPage, pageSize int64) ([]*othersBoughtRepo, error) {
	return nil, nil
}
...
// func (m *othersBoughtRepo) getProductVariants(productId int64) (*[]types.Variant, error) {
// 	nstmt, err := m.db.PrepareNamed(`
// 		SELECT
// 			*
// 		FROM variants
