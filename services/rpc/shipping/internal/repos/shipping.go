...
func newShipping(repo *repo) Shipping {
	return &shippingRepo{
		db:   repo.db,
		repo: repo,
...
// products
func (m *shippingRepo) GetProductBySku(sku string) (res *productResponse, err error) {
...
func (m *shippingRepo) GetProductBySlug(slug string) (res *productResponse, err error) {
	nstmt, err := m.db.PrepareNamed(`
		WITH p AS (
			SELECT 
				product.* 
...
func (m *shippingRepo) GetProductById(productID int64) (res *productResponse, err error) {
	nstmt, err := m.db.PrepareNamed(`
		WITH p AS (
			SELECT 
				product.* 
...
func (m *shippingRepo) GetProductsByCategoryId(categoryID, currentPage, pageSize int64, sortOn string) (res *getByCategoryIDResponse, err error) {
...
func (m *shippingRepo) GetAllProducts(currentPage, pageSize int64) ([]*shippingRepo, error) {
	return nil, nil
}

func (m *shippingRepo) Create(prod *models.Product) error {
...
func (m *shippingRepo) Update(prod *models.Product) error {
	if prod.ID == 0 {
...
func (m *shippingRepo) Save() error {
	return m.Product.Save(m.ctx, m.db)
}

func (m *shippingRepo) Upsert() error {
	return m.Product.Upsert(m.ctx, m.db)
}

func (m *shippingRepo) Delete(id int64) error {
...
// func (m *shippingRepo) getProductVariants(productId int64) (*[]types.Variant, error) {
// 	nstmt, err := m.db.PrepareNamed(`
// 		SELECT
// 			*
// 		FROM variants
